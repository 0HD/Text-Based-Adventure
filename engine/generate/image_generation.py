...
def describe_scene(prompt, history, logic):
    ...
    FLUX PROMPTS ARE SIMILAR TO STABLE DIFFUSION PROMPTS. SO IF YOU'RE NOT FAMILIAR WITH FLUX PROMPTS, JUST PRETEND IT'S A STABLE DIFFUSION MODEL AND WRITE A PROMPT FOR IT. MAKE SURE THE FLUX GENERATOR KNOWS THE CONSTRAINTS. MENTION ALL OF THE CONSTRAINTS CLEARLY.
